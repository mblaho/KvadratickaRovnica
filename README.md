...
- ${\mathit{ax}}^2$ je **kvadratický člen**,
- $\mathit{bx}$ je **lineárny člen**,
- $c$ je **absolútny člen**.
...
- Ak je $b=0$ nazývame rovnicu **rýdzo kvadratickou**: ${\mathit{ax}}^2 +c=0$.
- Ak je $c=0$ hovoríme o rovnici **bez absolútneho člena**: ${\mathit{ax}}^2 +\mathit{bx}=0$.

## **Riešenie kvadratickej rovnice**

Každú kvadratickú rovnicu je možné riešiť pomocou výpočtu **diskriminantu** *D*. Preň platí: $D=b^2 -4\mathit{ac}$. Môžu nastať 3 situácie:
